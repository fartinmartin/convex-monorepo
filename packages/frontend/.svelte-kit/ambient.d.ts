...
declare module '$env/static/private' {
	...
	export const npm_config_aggregate_output: string;
...
declare module '$env/static/public' {
	export const PUBLIC_CONVEX_API_URL: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NODE_PATH: string;
		XPC_FLAGS: string;
		npm_config_aggregate_output: string;
